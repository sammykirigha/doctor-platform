...
export const admin_routes = [
    {
		...
		children: [
            ...
            { path: "/admin/patients/new/", exact: true, component: AddPatient },
            {
                path: "/admin/patients/:id", exact: true, component: PatientsProfile,
                children: [
            ...
            {
                path: "/admin/doctors/:id", exact: true, component: DoctorsProfile,
                children: [
                     { path: "", component: Profile },
