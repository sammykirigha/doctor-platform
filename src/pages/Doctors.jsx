                        ...
                        >
                            <div className="flex items-center">
                                ...
                                <div className='flex flex-col absolute left-2 gap-2 visible'>
                                        <span className="h-10 w-10 opacity-70 drop-shadow-md rounded-full bg-blue-100 flex items-center justify-center cursor-pointer group hover:bg-blue-600 "><FiFacebook className="text-blue-500  group-hover:text-white "  /></span>
										<span className="h-10 w-10 opacity-70 drop-shadow-md rounded-full bg-blue-100 flex items-center justify-center cursor-pointer group hover:bg-blue-600 "><FiLinkedin className="text-blue-500 group-hover:text-white "  /></span>
										<span className="h-10 w-10 opacity-70 drop-shadow-md rounded-full bg-blue-100 flex items-center justify-center cursor-pointer group hover:bg-blue-600 "><FiGithub className="text-blue-500 group-hover:text-white " /></span>
										<span className="h-10 w-10 opacity-70 drop-shadow-md rounded-full bg-blue-100 flex items-center justify-center cursor-pointer group hover:bg-blue-600 "><FiTwitter className="text-blue-500 group-hover:text-white " /></span>
                                </div>
                            </div>
