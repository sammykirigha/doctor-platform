                        ...
                        >
                            <div className="flex items-center">
                                ...
                                <div className='hidden group-hover:flex flex-col absolute left-2 gap-2'>
                                        <span className="h-10 w-10 opacity-70 drop-shadow-md rounded-full bg-blue-200 flex items-center justify-center cursor-pointer group hover:bg-blue-600 "><FiFacebook className=" text-blue-900 group-hover:text-white "  /></span>
										<span className="h-10 w-10 opacity-70 drop-shadow-md rounded-full bg-blue-200 flex items-center justify-center cursor-pointer group hover:bg-blue-600 "><FiLinkedin className=" text-blue-900 group-hover:text-white"  /></span>
										<span className="h-10 w-10 opacity-70 drop-shadow-md rounded-full bg-blue-200 flex items-center justify-center cursor-pointer group hover:bg-blue-600 "><FiGithub className=" text-blue-900 group-hover:text-white" /></span>
										<span className="h-10 w-10 opacity-70 drop-shadow-md rounded-full bg-blue-200 flex items-center justify-center cursor-pointer group hover:bg-blue-600 "><FiTwitter className=" text-blue-900 group-hover:text-white" /></span>
                                </div>
                            </div>
