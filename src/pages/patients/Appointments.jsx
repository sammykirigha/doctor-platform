    ...
    return (
        <div className=" mt-5 bg-white ">
            <div className="h-[4rem] border border-b-gray-400 flex items-center justify-start gap-10 pl-3">
                <NavLink to="upcoming-appointments"   className={({isActive}) => isActive ? "text-xl text-gray-700 border-b border-blue-600" : "text-xl text-gray-700"}>upcoming appointments</NavLink>
