...
const Dashboard = () => {
    ...
    return (
        <div className="mx-5 bg-red-600 sm:px-3 sm:pt-3">
            <Title className="mt-8 ml-5" title={"Dashbord"} />
            <DashboardCards />
            <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2  ">
                {/* <div className=" w-[65%]"> */}
                    <div className="flex flex-col sm:w-[100%] md:w-[100%] lg:w-[100%]">
                        <MyChart />
                ...
                {/* </div> */}
                <div className="w-[100%] ml-5 gap-5 sm:ml-0 sm:mt-5 sm:mx-2 lg:ml-3 lg:mt-3">
                    <Radial />
